...
var coldVerticalImg = "images/coldVertical.png";
var tooltipFGImg = "images/tickShine.png";
var glassBottomImg = "images/glassBottom.png";
var coldBottomImg = "images/coldBottom.png";
...
var coldVerticalImg2x = "images/coldVertical2x.png";
var tooltipFGImg2x = "images/tickShine2x.png";
var glassBottomImg2x = "images/glassBottom2x.png";
var coldBottomImg2x = "images/coldBottom2x.png";
...
function determineImageSet(){
	...
	if(resolution2x){	
		...
		coldVerticalImg = coldVerticalImg2x;
		glassBottomImg = glassBottomImg2x;
		coldBottomImg = coldBottomImg2x;
		tootipPointImg = tootipPointImg2x;
		tooltipButtImg = tooltipButtImg2x;	
	}
	
	if(currentAmount<0){
		redVerticalImg = coldVerticalImg;
		glassBottomImg = coldBottomImg;
	}

	showAmount=currentAmount;
...
function animateThermometer(){
	...
	$({tipAmount: 0}).animate({tipAmount: showAmount}, {
